...
# This file was *autogenerated* from the file /Users/wojtek/Library/CloudStorage/GoogleDrive-w.politarczyk@uw.edu.pl/My Drive/mat/git-projects/signature_function/gaknot_lib/gaknot.sage
...
class GeneralizedAlgebraicKnot:
    ...
    def verify_description(desc):
        ...
        for i, element in enumerate(desc):
            ...
            # 2. Check the sign
            if sign not in (_sage_const_1 , -_sage_const_1 ):
            ...
            for j, cable_pair in enumerate(knot_desc):
                if not isinstance(cable_pair, (list, tuple)) or len(cable_pair) != _sage_const_2 :
    ...
    def is_positive_torus_knot(self):
        ...
        """
        if len(self) != _sage_const_1 :
            return False
            
        sign, knot_desc = self._desc[_sage_const_0 ]
        return sign == _sage_const_1  and len(knot_desc) == _sage_const_1 
    ...
    def __str__(self):
        ...
        for sign, knot_desc in self.description:
            ...
            prefix = "-" if sign == -_sage_const_1  else ""
