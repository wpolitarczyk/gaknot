...
# This file was *autogenerated* from the file /Users/wojtek/Library/CloudStorage/GoogleDrive-w.politarczyk@uw.edu.pl/My Drive/mat/git-projects/signature_function/gaknot_lib/character.sage
...
class Character:
    ...
    def restrict_to_layer(self, component_index, layer_index):
        ...
        """
        # Validate indices
        if component_index < _sage_const_0  or component_index >= len(self._homology.decomposition):
        ...
        if layer_index < _sage_const_0  or layer_index >= len(target_component['layers']):
