...
# This file was *autogenerated* from the file /Users/wojtek/Library/CloudStorage/GoogleDrive-w.politarczyk@uw.edu.pl/My Drive/mat/git-projects/signature_function/gaknot_lib/signature.sage
...
class SignatureFunction:
    ...
    def __rshift__(self, shift):
        ...
        counter = Counter({mod_one(k + shift) : v                           for k, v in self.jumps_counter.items()})
    ...
    def __mul__(self, number):
        ...
        counter = Counter({k : number * v                           for k, v in self.jumps_counter.items()})
        return SignatureFunction(counter=counter)
